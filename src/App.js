...
class App extends Component {
	...
	editTask = (data) =>{
		this.taskInput.input.value= data.title;
	...
	addTask = () => {
		...
		let arrayDat = this.state.items.map(obj => {
			if(obj===this.state.changeItem){
				obj.title = value;
		...
		return (
			<MuiThemeProvider>
				<div className="App">
					...
					/>
					<AppBar
						title={<span style={{color: 'white'}}>To-Do List (Test Task)</span>}
